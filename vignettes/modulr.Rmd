...
set.seed(1234L) 
.__not_travis_nor_cran__ <- !identical(Sys.getenv("TRAVIS"), "true") && 
    identical(Sys.getenv("NOT_CRAN"), "true")
knitr::opts_chunk$set(purl = .__not_travis_nor_cran__)
```
...
Finally, [GitHub Enterprise](https://enterprise.github.com) users are also covered. For instance:

```{r, eval=.__not_travis_nor_cran__}
httr::with_config(
  
  # As usual, set 'GITHUB_PAT' in your '.Renviron' file.
  httr::authenticate(user = "aclemen1", password = Sys.getenv("GITHUB_PAT")), 
  
  "test_module" %imports% 
    "https://github.unil.ch/api/v3/gists/e1d41efefa623c9a8c117bdf95633a9a"
