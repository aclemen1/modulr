...
```{r, eval=.__not_travis_nor_cran__, echo=FALSE}
(function() {
...
```{r, echo=FALSE, eval=.__not_travis_nor_cran__}
g <- release_gear_as_gist(browse = FALSE)
```

```{r, include=FALSE, eval=!.__not_travis_nor_cran__}
g <- list(html_url = "<URL>")
```
