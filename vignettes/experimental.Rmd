...
Using [Henrik Bengtsson's future package](https://CRAN.R-project.org/package=future), it is possible to evaluate modules asynchronously using various resources available to the user. For instance, evaluation of modules can be eager, lazy, and/or parallelized (on multiple cores and/or on a cluster of machines).
