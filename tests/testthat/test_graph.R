...
test_that("correct Sankey graph is returned for dependent modules", {
  ...
  expect_equal(
    ...
    structure(list(links = structure(list(source = c(0, 1), target = c(2, 2), value = c(1, 1)), .Names = c("source", "target", "value"), row.names = c(NA, -2L), class = "data.frame"), nodes = structure(list(name = structure(1:3, .Label = c("module_layer1_1", "module_layer1_2", "module_layer2_1"), class = "factor")), .Names = "name", row.names = c(NA, -3L), class = "data.frame")), .Names = c("links", "nodes"))) # Exclude Linting
